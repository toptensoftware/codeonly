...
`,pt=!1;function hi(){if(pt)return;pt=!0;let r=document.querySelector("script[type=importmap]");Z=Z.replace("##importmap##",(r==null?void 0:r.textContent)??"");let e=Array.from(document.querySelectorAll("link[rel=stylesheet]")).map(t=>`<link href="${t.getAttribute("href")}" rel="stylesheet">`).join(`
