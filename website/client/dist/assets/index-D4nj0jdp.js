...
`);ge.register({pattern:"/:pathname*",match:async r=>{try{return r.document=new vi(r.match.groups.pathname),await r.document.load(),r.page=new zt(r.document),!0}catch{r.page=new ft}return!0},order:10});var O,me;class qt extends M{constructor(){super();g(this,O);g(this,me,"");this.init(),require(["vs/editor/editor.main"],()=>{p(this,O,monaco.editor.create(this.editorContainer,{value:o(this,me),language:"javascript",theme:"vs-dark"})),p(this,me,null),o(this,O).getModel().onDidChangeContent(i=>{this.dispatchEvent(new Event("input"))}),this.resizeEditor()}),new ResizeObserver(()=>{this.resizeEditor()}).observe(this.editorContainer)}resizeEditor(){o(this,O)&&o(this,O).layout()}get editor(){return o(this,O)}get value(){return o(this,O)?o(this,O).getValue():o(this,me)}set value(t){o(this,O)?o(this,O).setValue(t):p(this,me,t)}}O=new WeakMap,me=new WeakMap,C(qt,"template",{type:"div",class:"editorContainer",style:"width: 100%; height: 100%;",bind:"editorContainer"});let $e=`<html>
<head>
...
`).length-1).toString())}class jt extends M{constructor(e){xi(),super(),this.script=e}get srcdoc(){return`${$e}${this.script}
        new Main().mount("body");
        ${$i}
        `}}C(jt,"template",{_:"iframe",attr_srcdoc:e=>e.srcdoc});var qe;class At extends M{constructor(){super();g(this,qe,"")}set script(t){p(this,qe,t),this.invalidate()}createIframe(){return new jt(o(this,qe))}}qe=new WeakMap,C(At,"template",{_:"div",id:"preview",$:{_:"embed-slot",content:t=>t.createIframe()}});J.declare(`
#preview
{
    position: relative;
    flex-grow: 1;
...
}`;var De,je,Pe;class Ut extends M{constructor(t){super();g(this,De,!1);g(this,je,null);g(this,Pe,null);C(this,"showErrors",!0);this.init(),this.editor.value=(t==null?void 0:t.code)??Ci,this.preview.script=this.editor.value,this.onIFrameMessage=this.onIFrameMessage.bind(this),window.addEventListener("message",this.onIFrameMessage)}destroy(){window.removeEventListener("message",this.onIFrameMessage)}onIFrameMessage(t){t.data.action=="error"&&(this.error=`line: ${t.data.error.lineno} col: ${t.data.error.colno}: ${t.data.error.message}`)}get error(){return o(this,je)}set error(t){p(this,je,t),this.invalidate()}onCodeChange(){this.error=null,!o(this,De)&&(o(this,Pe)!=null&&clearTimeout(o(this,Pe)),p(this,Pe,setTimeout(()=>{p(this,De,!0),this.preview.script=this.editor.value,p(this,De,!1)},500)))}async onCopyLink(){if(navigator.clipboard){let t=new URL(window.location),i=JSON.stringify({code:this.editor.value});t.hash=await Si(await Ni(i)),navigator.clipboard.writeText(t.href),alert("Link copied to clipboard")}}onShowErrorsChanged(t){this.showErrors=t.target.checked,this.invalidate()}onDownload(){ki(this.editor.value)}}De=new WeakMap,je=new WeakMap,Pe=new WeakMap,C(Ut,"template",{type:"div",class:"sandbox",$:[{type:"div",class:"editor-container",$:[{type:qt,bind:"editor",on_input:t=>t.onCodeChange()},{_:"div",class:"error",display:t=>!!t.error&&t.showErrors,text:t=>t.error}]},{type:"div",class:"preview-container",$:[{type:At,bind:"preview"},{type:"footer",$:[{type:"label",$:[{type:"input",attr_type:"checkbox",attr_checked:"checked",class:"switch",on_click:(t,i)=>t.onShowErrorsChanged(i)},"Show Errors"]},{type:"button",class:"subtle",text:"Copy Link",on_click:t=>t.onCopyLink()},{type:"button",class:"subtle",text:"Download",on_click:t=>t.onDownload()}]}]}]});J.declare(`
.sandbox
{
    display: flex;
    align-items: stretch;
